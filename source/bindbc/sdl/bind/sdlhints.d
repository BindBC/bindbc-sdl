...
static if(sdlSupport >= SDLSupport.sdl2022) {
    enum SDL_HINT_FORCE_RAISEWINDOW = "SDL_HINT_FORCE_RAISEWINDOW";
    enum SDL_HINT_IME_SUPPORT_EXTENDED_TEXT = "SDL_HINT_IME_SUPPORT_EXTENDED_TEXT";
    enum SDL_HINT_JOYSTICK_GAMECUBE_RUMBLE_BRAKE = "SDL_HINT_JOYSTICK_GAMECUBE_RUMBLE_BRAKE";
    enum SDL_HINT_JOYSTICK_ROG_CHAKRAM = "SDL_HINT_JOYSTICK_ROG_CHAKRAM";
    enum SDL_HINT_MOUSE_RELATIVE_MODE_CENTER = "SDL_HINT_MOUSE_RELATIVE_MODE_CENTER";
    enum SDL_HINT_MOUSE_AUTO_CAPTURE = "SDL_HINT_MOUSE_AUTO_CAPTURE";
    enum SDL_HINT_VITA_TOUCH_MOUSE_DEVICE = "SDL_HINT_VITA_TOUCH_MOUSE_DEVICE";
    enum SDL_HINT_VIDEO_WAYLAND_PREFER_LIBDECOR = "SDL_HINT_VIDEO_WAYLAND_PREFER_LIBDECOR";
    enum SDL_HINT_VIDEO_FOREIGN_WINDOW_OPENGL = "SDL_HINT_VIDEO_FOREIGN_WINDOW_OPENGL";
    enum SDL_HINT_VIDEO_FOREIGN_WINDOW_VULKAN = "SDL_HINT_VIDEO_FOREIGN_WINDOW_VULKAN";
    enum SDL_HINT_X11_WINDOW_TYPE = "SDL_HINT_X11_WINDOW_TYPE";
    enum SDL_HINT_QUIT_ON_LAST_WINDOW_CLOSE = "SDL_HINT_QUIT_ON_LAST_WINDOW_CLOSE";
    enum SDL_HINT_VIDEODRIVER = "SDL_HINT_VIDEODRIVER";
    enum SDL_HINT_AUDIODRIVER = "SDL_HINT_AUDIODRIVER";
}
